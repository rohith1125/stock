...
# Step 2: Implement the PRISM Algorithm with Overfitting Prevention

def prism_algorithm(data, target_class, min_coverage=5, max_conditions=2, significance_level=0.05):
    rules = []
...
# Generate rules using the PRISM algorithm with overfitting prevention
target_class = 1  # We are generating rules for NextDayUp = 1
rules = prism_algorithm(training_data, target_class, min_coverage=5, max_conditions=2, significance_level=0.05)
