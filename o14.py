...
# Step 2: Implement the PRISM Algorithm from scratch
        ...
        while True:
            ...
            for feature in features:
                ...
                if data_subset[feature].dtype == 'object':
                    ...
                    # Consider thresholds at midpoints between sorted unique values
                    ...
                    for threshold in thresholds:
                        ...
                        subset = data_subset[condition]
                        if len(subset) == 0 or len(subset) == len(data_subset):
                            continue
                        accuracy = sum(subset['NextDayUp'] == target_class) / len(subset)
                        if accuracy > best_accuracy:
                            best_accuracy = accuracy
