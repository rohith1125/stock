...
def prism_algorithm(data, target_class, min_coverage=1, max_conditions=5, significance_level=0.2):
    rules = []
...
rules = prism_algorithm(
    training_data,
    target_class,
    min_coverage=1,         # Lowered to allow more specific rules
    max_conditions=5,       # Increased to capture more complex patterns
    significance_level=0.2  # Increased to include more conditions
)
